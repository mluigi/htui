...
- **Languages:** rust (primary), bash, gitignore, json, markdown, sql, toml, yaml
- **Entry points:** `crates/htui-store/build.rs`, `crates/htui/src/main.rs`
- **Most-referenced symbols:** `Debug` (1206 usages), `iter` (1008 usages), `Clone` (882 usages), `PartialEq` (747 usages), `Eq` (534 usages), `StoreRequest` (423 usages), `StoreError` (408 usages), `get` (389 usages), `DriverEvent` (338 usages), `StoreReply` (338 usages)
- **Graph size:** 20916 nodes, 167522 edges
- **Breakdown:** 277 columns, 708 constants, 54 docs, 2911 fields, 476 files, 3646 functions, 325 generic_params, 25 interfaces, 7 macros, 2414 methods, 2 migrations, 245 packages, 6558 params, 33 tables, 817 types, 2418 variables
