...
**Status: CONFIRMED by the maintainer 2026-09-26** with OQ-9..OQ-13 defaults as written and **OQ-8 overturned**: judge prompts carry skills (D44, D48, D49), and untouched seeded `judge` templates are migrated to the new default (D49).
