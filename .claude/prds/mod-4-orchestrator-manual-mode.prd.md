...
| 5 | Two runs do not collide, and a crash is survivable | The overlap predicate, the admission transaction, the lease and its refresh, and the recovery sweep's artefact test — including the refusal to reset a dirty tree. | pending | — |
