...
| 3 | A mismatch is refused by name | `R-ORCH-10` at enqueue and at claim, the engine's box-tag seam, criterion 14's capability half as its own conformance case. | complete (`a9d2908`..`d73d120`, 2026-09-26) | [plan](../plans/mod-7-capability-refusal.plan.md), [blueprint](../plans/mod-7-capability-refusal.blueprint.md) |
| 4 | Paths and excerpts are real | Repo paths inferred per project under the workspace root with a manual text box on failure, and phase, judge and preview prompts carry excerpts read from those roots. | complete (`e4ca5b3`..`c46a11e`, 2026-09-26) | [plan](../plans/mod-7-paths-excerpts.plan.md), [blueprint](../plans/mod-7-paths-excerpts.blueprint.md) |
