...
> items: **ANA-22** (how a skill is stored and when it activates) and **MOD-50** (asking an agent for
...
- **Also served**: MOD-12 (auto mode runs whatever templates and skills are bound), MOD-26 (personas
  will be built on the same editor), MOD-50 (agent help plugs into this editor).
...
- **Agent help while editing** — **MOD-50**, opened at this PRD gate.
